...
parser.add_argument('--read_sim', action="store", help="Read simulator to use",
                    choices=["art", "wgsim", "nanosim", "pbsim"], default="art") # TODO: improve documentation - what to use when?
parser.add_argument('--read_sim_path', action="store",
                    help="Path to read simulator executable (default: ART shipped with CAMISIM)", default=False) # TODO: is this the nice way?
